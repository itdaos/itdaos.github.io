$(document).ready(function() {
  ...
  $("#cab-trigger-1").click(function () {
    $("#cab-tabs-1").removeClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-2").addClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-3").addClass("d-md-none d-lg-none d-xl-none");
  ...
  $("#cab-trigger-2").click(function () {
    $("#cab-tabs-2").removeClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-1").addClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-3").addClass("d-md-none d-lg-none d-xl-none");
  ...
  $("#cab-trigger-3").click(function () {
    $("#cab-tabs-3").removeClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-2").addClass("d-md-none d-lg-none d-xl-none");
    $("#cab-tabs-1").addClass("d-md-none d-lg-none d-xl-none");
